...
async function robot() {
  ...
  async function uploadVideo(content) {
    ...
    function onUploadProgress(event) {
      const progress = Math.round((event.byteRead / videoFileSize) * 100);
      console.log(`> ${progress}% completed of ${videoFileSize}`);
    }
  }
